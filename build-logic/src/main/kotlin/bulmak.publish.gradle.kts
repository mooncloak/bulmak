...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("bulmak")
        description.set("kotlinx.html Bulma components.")
        url.set("https://github.com/mooncloak/bulmak")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/bulmak/issues")
        ...
        developers {
            ...
            developer {
                ...
                roles.set(setOf("Primary bulmak developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/bulmak.git")
            developerConnection.set("https://github.com/mooncloak/bulmak.git")
            url.set("https://github.com/mooncloak/bulmak")
        }
    }
}
